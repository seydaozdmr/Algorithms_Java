...
public class Interval1D {
	...
	public static void main(String[] args) {
		...
		//Sıralanmamış
		System.out.println("Sıralanmamış düzenleme");
		for(int i=0;i<aralik.length;i++) {
			System.out.println(aralik[i]);
		}

		System.out.println("Küçük noktalara göre sıralama");
        Arrays.sort(aralik, Interval1D.MIN_ENDPOINT_ORDER);
        for (int i = 0; i < aralik.length; i++)
			System.out.println(aralik[i]);
		System.out.println();

		System.out.println("Büyük bitiş noktasına göre sıralama");
        Arrays.sort(aralik, Interval1D.MAX_ENDPOINT_ORDER);
        for (int i = 0; i < aralik.length; i++)
			System.out.println(aralik[i]);
		System.out.println();

		System.out.println("Uzunluğa göre sıralama");
